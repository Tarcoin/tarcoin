      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 max-w-3xl mx-auto text-lg">
            ...
            adoption, sustainable mining, and scalable digital infrastructure. The supply is fixed and
            immutable, with no hidden inflation or admin minting. 10 Billion TAR is reserved for ecosystem
            growth, infrastructure, and future development, while 40 Billion TAR will be distributed through
            mining over approximately 15–20 years. Halving occurs every 400,000 blocks, ensuring a
            sustainable emission schedule for decades.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-lg font-orbitron text-tarcoin-gold">🔐 Reserved Supply — Ecosystem Treasury</h3>
              <p className="text-xs text-gray-400 mt-1">10 Billion TAR secured and managed for long-term ecosystem growth.</p>
            </div>
          </div>
          <div className="bg-black/30 rounded-xl p-5 border border-tarcoin-gold/10">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              The 10 Billion TAR reserve is managed by the TARCOIN founding team and will be deployed
              strategically for ecosystem growth, exchange listings, infrastructure, developer compensation,
              and community initiatives. Reserve deployments will be communicated through official channels.
              The founding team retains full discretion over the timing and allocation of reserved funds to
              best serve the long-term growth of the network.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="p-6 border-b border-tarcoin-gold/10">
            <h3 className="text-xl font-orbitron font-bold text-tarcoin-gold">Emission Schedule</h3>
          </div>
