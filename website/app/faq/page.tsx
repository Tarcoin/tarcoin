          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }}
              ...
              {[
                ...
                { q: "What is the smallest unit of TAR?", a: "The smallest unit of TAR (0.00000001 TAR) is officially called a Stella (symbol: sTAR). 1 full TAR is made up of exactly 100 million Stellas." },
