          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }}
              ...
              {[
                ...
                { q: "Can I mine TAR with my Bitcoin ASIC?", a: "Yes! TARCOIN uses the same SHA256d algorithm as Bitcoin. Any Bitcoin ASIC miner or CPU miner can mine TAR by pointing it to stratum+tcp://stratum.tarcoin.org:3333 with your TAR wallet address as the username and any password (e.g. x)." },
