          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }}
              ...
              {[
                ...
                { step: "2", title: "Configure Your ASIC Miner", desc: "Access your ASIC miner's web interface and enter the pool configuration: Primary URL: stratum+tcp://stratum.tarcoin.org:3333, Backup URL: stratum+tcp://stratum2.tarcoin.org:3333, Worker: [Your TAR Address], Password: anything (or x)." },
