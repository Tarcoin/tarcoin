...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin AND TARGET tarcoin-qt AND TARGET bitcoind AND TARGET bitcoin-cli AND TARGET bitcoin-tx AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_bitcoin)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:tarcoin-qt> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:tarcoin-qt>
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET tarcoin-qt)
    set(macos_app "Tarcoin-Qt.app")
    ...
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Tarcoin-Qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component tarcoin-qt --prefix ${macos_app}/Contents/MacOS --strip
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:tarcoin-qt> ${macos_app}/Contents/MacOS/Tarcoin-Qt
      COMMAND ${CMAKE_COMMAND} -E rm -rf ${macos_app}/Contents/MacOS/bin
      COMMAND ${CMAKE_COMMAND} -E rm -rf ${macos_app}/Contents/MacOS/share
      VERBATIM
    )

    set(macos_zip "tarcoin-macos-app")
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Tarcoin-Qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Tarcoin-Qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Tarcoin-Qt
      )
    ...
    add_dependencies(deploydir tarcoin-qt)
