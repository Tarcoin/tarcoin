...
static RPCMethod waitfornewblock()
{
    return RPCMethod{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (tarcoin-cli -rpcclienttimeout=0)",
                {
...
static RPCMethod getblockstats()
{
    return RPCMethod{
        "getblockstats",
        "Compute per block statistics for a given window. All amounts are in taroshi.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", /*optional=*/true, "Average feerate (in taroshi per virtual byte)"},
                {RPCResult::Type::NUM, "avgtxsize", /*optional=*/true, "Average transaction size"},
                {RPCResult::Type::STR_HEX, "blockhash", /*optional=*/true, "The block hash (to check for potential reorgs)"},
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", /*optional=*/true, "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in taroshi per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", /*optional=*/true, "Maximum feerate (in taroshi per virtual byte)"},
                {RPCResult::Type::NUM, "maxtxsize", /*optional=*/true, "Maximum transaction size"},
                {RPCResult::Type::NUM, "medianfee", /*optional=*/true, "Truncated median fee in the block"},
                {RPCResult::Type::NUM, "mediantime", /*optional=*/true, "The block median time past"},
                {RPCResult::Type::NUM, "mediantxsize", /*optional=*/true, "Truncated median transaction size"},
                {RPCResult::Type::NUM, "minfee", /*optional=*/true, "Minimum fee in the block"},
                {RPCResult::Type::NUM, "minfeerate", /*optional=*/true, "Minimum feerate (in taroshi per virtual byte)"},
...
static RPCMethod scanblocks()
{
    return RPCMethod{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (tarcoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCMethod getdescriptoractivity()
{
    return RPCMethod{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (tarcoin-cli -rpcclienttimeout=0)",
        {
...
static RPCMethod dumptxoutset()
{
    return RPCMethod{
        ...
        "For deep rollbacks, make sure to use no RPC timeout (tarcoin-cli -rpcclienttimeout=0) as it may take several minutes.",
        {
...
static RPCMethod loadtxoutset()
{
    return RPCMethod{
        ...
        "The result is a usable tarcoind instance that is current with the network tip in a "
