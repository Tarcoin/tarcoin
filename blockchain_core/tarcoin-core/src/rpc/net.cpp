...
static RPCMethod addnode()
{
    return RPCMethod{
        ...
        "Attempts to add or remove a node from the addnode list.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:19333\" \"onetry\" true")
            + HelpExampleRpc("addnode", "\"192.168.0.6:19333\", \"onetry\" true")
                },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCMethod addconnection()
{
    return RPCMethod{
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:19333\" \"outbound-full-relay\" true")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:19333\" \"outbound-full-relay\" true")
        },
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
