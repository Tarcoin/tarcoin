    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The TARCOIN-Qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of tarcoind with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
